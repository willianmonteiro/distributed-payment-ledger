...
export class OutboxRelayService {
  ...
  /**
   * Runs one poll-publish-mark cycle and returns how many events it published.
   * Public (rather than only the scheduled handler below) so tests can drive it
   * directly instead of racing a background interval.
   */
